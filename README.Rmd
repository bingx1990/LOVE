...
LOVE performs overlapping clustering of feature variables under a structured 
latent factor model.
...
This is a basic example which shows you how to use the main function of LOVE. 
We start by generating a synthetic data set. 
...
\code{LOVE} function. The function \code{Screen_X} detects the features that are
close to pure noise. The following example demonstrates the usage of 
\code{Screen_X}.
